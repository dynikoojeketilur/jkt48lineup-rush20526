...
const MEMBERS = [
  ...
  { id:'pas04',  name:'Cornelia Vanisa',        team:'passion', img_closed:'assetsclosedpas04.jpg',  img_open:'assets/open/pas04.jpg'  },
...
function imgO(m) {
  const c = TEAM_COLOR[m.team].replace('#', '');
  return m.img_open || `https://placehold.co/180x250/${c}/fff?text=${encodeURIComponent(m.name.split(' ')[0])}`;
}
